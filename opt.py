...
datamodule = SemanticSegmentationData.from_folders(
    ...
    train_folder="/projects/EWS_herbifly/data2/train/images",
    train_target_folder="/projects/EWS_herbifly/data2/train/masks",
    val_folder="/projects/EWS_herbifly/data2/validation/images",
    val_target_folder="/projects/EWS_herbifly/data2/validation/masks",
...
checkpointing = ModelCheckpoint(
    ...
    monitor="val_f1score",
    mode="max",
    filename="EWS_herbifly_best-{epoch:02d}-{step:.2f}",
